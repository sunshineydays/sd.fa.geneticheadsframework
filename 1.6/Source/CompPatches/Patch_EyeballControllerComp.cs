    ...
    public static class Patch_EyeballControllerComp
    {
        ...
        static bool Prefix(object __instance)
        {
            try
            {
                ...
                if (fi.FieldType != typeof(EyeballTypeDef))
                {
                   //Log.Warning($"[FA Genetic Heads] faceType field is not of type {typeof(EyeballTypeDef).Name}");
                    return true;
                }
                ...
                if (chosen != null)
                {
                    ...
                    if (Prefs.DevMode)
                        Log.Message($"[FA Genetic Heads] {typeof(EyeballTypeDef).Name}: assigned {chosen.defName} to {pawn.LabelShortCap}");
                }
