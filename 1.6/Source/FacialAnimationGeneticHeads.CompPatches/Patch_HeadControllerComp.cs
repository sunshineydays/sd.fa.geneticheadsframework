...
public static class Patch_HeadControllerComp
{
	...
	{
		return AccessTools.Method(AccessTools.TypeByName("FacialAnimation.HeadControllerComp"), "InitializeIfNeed");
	}
	...
	private static bool Prefix(object __instance)
	{
		try
		{
			...
			if (fieldInfo.FieldType != typeof(FacialAnimation.HeadTypeDef))
			{
				return true;
			}
