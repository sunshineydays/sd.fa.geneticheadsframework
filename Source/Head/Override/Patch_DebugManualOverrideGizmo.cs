...
namespace FacialAnimationGeneticHeads
{
    ...
    public static class Patch_DebugManualOverrideGizmo
    {
        ...
        {
            if (!Prefs.DevMode || !FAGeneticHeadsMod.settings.showManualOverrideGizmo || __instance == null || !__instance.RaceProps.Humanlike)
                return;
            ...
            list.Add(new Command_Action
            {
                ...
                action = () =>
                {
                    ...
                    foreach (var head in allHeads)
                    {
                        ...
                        {
                            Utility_ApplyManualHeadOverride.ApplyManualHeadOverride(__instance, head);
                        }));
                    }
